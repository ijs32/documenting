...
%   Symbol & Meaning \\
%   \midrule
%   $Y_e(x)$ & Output of the expensive simulation at input $x$ \\
%   $Y_c(x)$ & Output of the cheaper simulation at input $x$ \\
%   $\rho$   & Regression parameter linking the cheap and expensive codes \\
%   \bottomrule
% \end{tabularx}
% \end{center}
...
\begin{description}
  ...
  \item[Spatial effects] relate to persistent plasma properties affecting particle transport over large areas.
...
\begin{mytake}
What I think this actually means, or why it matters to me.
\end{mytake}
